...
class Spider2Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield scrapy.FormRequest("http://epub.sipo.gov.cn/patentoutline.action",
            formdata={'showType': '1', 'strWhere': self.date, 'numSortMethod': '5', 'strLicenseCode': '', 'numIp': '', 'numIpc': '', 'numIg': '0', 'numIgc': '', 'numIgd': '', 'numUg': '', 'numUgc': '', 'numUgd': '', 'numDg': '', 'numDgc': '',
    ...
    def post_link(self, response):
        ...
        if hxs.xpath('//div[@class="main"]/dl/dd/ul/li[3]/a/@href').extract() != []:
            ...
            item['downloadlink'] = hxs.xpath('//div[@class="main"]/dl/dd/ul/li[3]/a/@href').extract()[0]
        else:
