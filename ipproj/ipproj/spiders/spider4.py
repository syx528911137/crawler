...
class Spider4Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield scrapy.FormRequest("http://epub.sipo.gov.cn/patentoutline.action",
            formdata={'showType': '1', 'strWhere': self.date, 'numSortMethod': '5', 'strLicenseCode': '', 'numIp': '', 'numIpc': '', 'numIg': '', 'numIgc': '', 'numIgd': '', 'numUg': '', 'numUgc': '', 'numUgd': '', 'numDg': '0', 'numDgc': '',
